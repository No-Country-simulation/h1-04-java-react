  ...
  return (
    <div className="w-full flex flex-col items-center py-2 md:py-10">
      <div className="w-full max-w-xl flex flex-col items-center gap-6">
        ...
        <div className="w-[90%] md:w-full text-center text-gray-700 text-base font-semibold leading-tight">
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center gap-16 mt-20">
        ...
        <div className="w-[90%] md:w-full lg:w-1/2 flex flex-col items-center gap-10 pb-20">
          {/* Primer elemento */}
          <div className="w-full max-w-[570px] h-[560px] flex flex-col gap-20">
            <div className="w-full h-40 relative">
              ...
              <div className="absolute left-[59px] top-[72px] text-[#555555] text-base font-semibold leading-tight mr-8 md:mr-24">
