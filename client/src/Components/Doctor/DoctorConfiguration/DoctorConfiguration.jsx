  ...
  return (
    <section className='container mt-5'>
      <article className='userPictureName'>
        ...
        />
        <p
          className='font-bold text-center mb-5 mt-1'
          style={{ color: "#5A5555", fontSize: "23px" }}
        >
          {patientData
      ...
      <article className='optionsContainer'>
        <div>
          <button
            className='flex justify-between optionBlue'
            onClick={() => {
          ...
          >
            ...
            <img
              src={arrowOrange}
              alt='arrow'
              className={`w-4 h-6 ml-4 imageBlue ${
                isOpen[1] ? "arrow-rotate-treatment" : "more-more-arrow-rotate"
              }`}
            />
          </button>
          {personalData && (
        ...
        <div>
          ...
          >
            ...
            <img
              ...
              alt='arrow'
              className={`w-4 h-6 ml-4 imageBlue ${
                isOpen[2] ? "arrow-rotate-treatment" : "more-more-arrow-rotate"
              }`}
            />
          </button>
          {notifications && (
        ...
        <button
          onClick={() => log()}
          className='w-full self-end rounded py-2 mt-10 optionBlue'
        >
          Cerrar sesion
        </button>
      </article>
